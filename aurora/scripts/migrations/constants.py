...
将 aurora.core.constants 的导入自动迁移到当前的模块化结构。

用法：
    python -m aurora.scripts.migrations.constants <file_or_directory>

示例：
    python -m aurora.scripts.migrations.constants aurora/
    python -m aurora.scripts.migrations.constants aurora/soul/engine.py
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python -m aurora.scripts.migrations.constants <path> [--dry-run]")
        sys.exit(1)
