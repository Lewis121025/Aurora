...
公共入口保留在本模块，内部实现拆分为：
- coherence_models.py：共享数据模型
- coherence_components.py：分析组件和基础冲突解决
- CoherenceGuardian：张力分析与知识冲突策略编排
"""
...
from aurora.core.coherence.components import (
    BeliefNetwork,
    CoherenceScorer,
    ConflictResolver,
    ContradictionDetector,
)
from aurora.core.coherence.models import (
    BeliefState,
    CoherenceReport,
    Conflict,
    ConflictType,
...
from aurora.core.knowledge import ConflictAnalysis, KnowledgeClassifier, KnowledgeType
...
from aurora.core.tension import Tension, TensionManager, TensionType
