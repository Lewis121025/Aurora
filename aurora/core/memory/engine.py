...
try:
    from aurora.core.graph.faiss_index import FAISS_AVAILABLE, FAISSVectorIndex
except ImportError:
    ...
    def __init__(
        ...
        参数：
            ...
            seed：用于可重复性的随机种子。所有随机决策
                ...
                此种子。默认为 0。
            embedder：可选的嵌入提供者。如果为 None，使用
                LocalSemanticEmbedding 作为本地默认值。对于生产环境，
                可以提供更强的嵌入器，如 BailianEmbedding 或 ArkEmbedding。
        ...
        注意：
            内存系统使用多个可学习的组件：
            - LocalSemanticEmbedding：默认本地语义嵌入
            - HashEmbedding：仅用于可重复性的确定性测试嵌入
...
"""
    ...
    def query(
        ...
        示例：
            ...
            >>> # 显式时间查询
            >>> from aurora.core.retrieval import QueryType
