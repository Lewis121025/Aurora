...
from aurora.soul.extractors import HeuristicMeaningExtractor, MeaningExtractor
    ...
    def from_state_dict(
        ...
        *,
        ...
        if data.get("schema_version") != SOUL_MEMORY_STATE_VERSION:
            raise ValueError("Detected legacy memory snapshot. Aurora Soul requires a fresh data directory.")
