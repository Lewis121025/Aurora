...
class TestStoryArc:
    ...
    def test_story_round_trip(self, relationship_story: StoryArc):
        ...
        assert (
            restored.my_identity_in_this_relationship
            == relationship_story.my_identity_in_this_relationship
        )
...
class TestTheme:
    ...
    def test_add_supporting_relationship(self, basic_theme: Theme):
        ...
        expected_strength = (
            0.5 * 0.5 + 0.3 * expected_relationship_factor + 0.2 * expected_story_factor
        )
